...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(55), __webpack_require__(4), __webpack_require__(33), __webpack_require__(69) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(t, e, i, n, s) {
    "use strict";
    return i.extend({
        Controller: n,
        eventPrefix: "change:",
        ...
        bind: function() {
            return this._mapEvents(), this._nodes = this.$view.children().toArray().map(this.decorate, this), 
            this;
        },
        unbind: function() {
            return this._undelegateEvents(), this;
        },
        decorate: function(t) {
            var e = new this.Controller(t);
            return e.on && (this.listenTo(e, "destroy", function() {
                this.remove(e);
            }), this.listenTo(e, "all", this.forwardEvents)), e;
        },
        forwardEvents: function() {
            var t = this.eventPrefix + arguments[0], e = [].slice.call(arguments, 1);
            this.trigger.bind(this, t).apply(this, e);
        },
        add: function(t) {
            if (t && Array.isArray(t)) {
                var e = t.map(this.decorate, this).filter(Boolean);
                return e.forEach(function(t) {
                    return t.render && t.render(this.$view);
                }, this), this._nodes = this._nodes.concat(e), this.trigger("update", this.getNodes()), 
                e;
            }
        },
        remove: function(t) {
            var e;
            (e = this._nodes.indexOf(t)) !== -1 && (this._nodes.splice(e, 1), this.stopListening(t, "all", this.forwardEvents), 
            this.trigger("update", this.getNodes()));
        },
        empty: function() {
            return this._nodes ? (this._nodes.forEach(function(t) {
                t && (t.off && this.stopListening(t), t.destroy && t.destroy());
            }, this), this._nodes.length = 0, this.trigger("update", this.getNodes()), this.$view.empty()) : this.$view;
        },
        isEmpty: function() {
        ...
        init: function(t, e) {
            var i = new this(t);
            return i.Controller = e || i.Controller, i.bind();
        }
    }).mixin(s);
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(10), __webpack_require__(704) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, i, r) {
    "use strict";
    r.init(e(".js-curated-galleries"), i);
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(46), __webpack_require__(55), __webpack_require__(3), __webpack_require__(165), __webpack_require__(121) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(t, i, n, e, s) {
    "use strict";
    return e.extend({
        dataKey: "data",
        offsetKey: "offset",
        Container: s,
        init: function(t) {
            this._super(), n(this, t), this._Container = this.Container.extend();
        },
        hasMoreResults: function(t) {
            var i = !(!t || !t[this.offsetKey]);
            return i || (this.unbind(), this._container.isEmpty() && this.trigger("empty")), 
            i;
        },
        getNextOffset: function(t) {
        ...
        loaded: function(t) {
            var i = t[this.dataKey];
            this._container.add(i);
        },
        at: function(t) {
            if (!t) throw new Error("Context must be defined");
            return this._container = this._Container.init(t), this.listenTo(this._container, "update", this.trigger.bind(this, "update")), 
            "visible" !== t.css("overflowX") && (this.context = t[0].id ? "#" + t[0].id : this.context), 
            this;
        },
        of: function(t) {
            return this._container ? (this._container.Controller = t, this) : (this._Container.mixin({
                Controller: t
            }), this);
        },
        _xhrOptions: function() {
            var t = this._super();
            return this._model && n(t.data, this._model.data()), t;
        },
        bind: function(i, n) {
            return i && i.data && (this._model && this.stopListening(this._model), this._model = i, 
            this.listenTo(i, "all", function i() {
                i.throttle || (i.throttle = !0, t(function() {
                    this.trigger("reload"), this.reload(), this._container && this._container.empty(), 
                    i.throttle = !1;
                }.bind(this)));
            })), n ? (this.reload(), this) : this._super();
        },
        destroy: function() {
            this._model && (this.stopListening(this._model), this._model = null), this._container && (this._container.destroy(), 
            this._container = null), this._super();
        },
        isEmpty: function() {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(4), __webpack_require__(32), __webpack_require__(313), __webpack_require__(41), __webpack_require__(66), __webpack_require__(839), __webpack_require__(837), __webpack_require__(147) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(t, i, e, s, n, o, l, r, a) {
    "use strict";
    return i.extend({
        init: function(t, i) {
            this._$context = t, this._data = i;
        },
        bind: function() {
            a.init(), this.relay(a, "postload"), this._bindFilters(), this._bindResults(), this._bindLoadingState(), 
            o.init(this._$context, this._$context, t(".js-footer")), n.init(this._$context);
        },
        unbind: function() {
            a.destroy(), this._filters.destroy(), this._results.destroy();
        },
        _bindFilters: function() {
            var i = new e({
                category: this._data.category,
                content: this._data.filters.content,
                queues: this._data.filters.queues
            });
            this._filters = l.init(t(".js-galleries-header"), i);
        },
        _bindLoadingState: function() {
            s.init(this._$context), this._results.on({
                reload: s.global,
                "success error": s.off
            });
        },
        _bindResults: function() {
            this._results = r.init(this._$context.find(".js-gallery-list"), this._filters._model, {
                offset: this._data.defaults.ordinal,
                urlSegment: this._data.URLS.API.GALLERIES
            });
        }
    });
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(33), __webpack_require__(27), __webpack_require__(101), __webpack_require__(92) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, r, t, n) {
    "use strict";
    var o = r.extend({
        template: t,
        rendered: function(e) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(2), __webpack_require__(399), __webpack_require__(836), __webpack_require__(838) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, t, n, o) {
    "use strict";
    return t.extend({
        offsetKey: "ordinal",
        dataKey: "entities",
        _xhr: e,
        _xhrOptions: function() {
            var e = this._super(), t = e.data;
            return t.queues = t.queues.join("|"), e.url = this.urlSegment + "/" + t.category.id + "/" + t.content, 
            this.contentType !== t.content && (this.contentType = t.content, this.of("projects" === t.content ? n : o)), 
            delete t.category, delete t.content, e;
        }
    }, {
        init: function(e, t, r) {
            var i = new this(r), s = t.get("content"), c = "projects" === s ? n : o;
            return i.of(c).at(e), i.bind(t), i.contentType = s, i;
        },
        displayName: "ResultsController"
    });
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(33), __webpack_require__(27), __webpack_require__(41), __webpack_require__(360) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, t, r, l) {
    "use strict";
    var n = t.extend({
        template: l,
        rendered: function() {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(4), __webpack_require__(29), __webpack_require__(57), __webpack_require__(175), __webpack_require__(13) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(t, e, i, n, s, o) {
    "use strict";
    return e.extend({
        init: function(e, i, n) {
            this._$context = e, this._model = i, this._$window = n || t(window), this._$contentTypes = e.find(".js-content"), 
            this._$queues = e.find(".js-queue"), this._initialState = this._getStateFromModel();
        },
        _getStateFromModel: function() {
            return {
                context: "curatedGallery",
                data: t.extend(!0, {}, this._model.data())
            };
        },
        bind: function() {
            this._$contentTypes.on("click", this._clickContent.bind(this)), this._$queues.on("click", this._clickQueue.bind(this)), 
            this.listenTo(this._model, {
                ...
                "content queues": function() {
                    o.info("gallery_filter_events", "Gallery filters updated", this._model.data());
                }
            }), this._$window.on("popstate.galleries_filters", this._handlePopState.bind(this)), 
            i.is("desktop") || this._bindScrollNav(), i.on("desktop:exit", this._bindScrollNav.bind(this)), 
            i.on("desktop:enter", this._clearScrollNav.bind(this));
        },
        unbind: function() {
            this._$window.off("popstate.galleries_filters");
        },
        _bindScrollNav: function() {
            this._scroller = s(this._$context, !0, 1e3), this._scroller.scrollToElement(".selected", 0);
        },
        _clearScrollNav: function() {
            this._$context.find(".js-iscroll-wrap").css("overflow", "visible").find(".js-iscroll").css("width", "");
        },
        _handlePopState: function(e) {
            var i = t.isEmptyObject(e.originalEvent.state) ? this._initialState : e.originalEvent.state;
            "curatedGallery" === i.context && this._model.set(i.data);
        },
        _serializeDataToUrl: function() {
            var e = this._model.data(), i = e.category.label.replace(" ", "-"), n = {
                content: e.content
            };
            return e.queues.length && (n.queues = e.queues.join("|")), "/galleries/" + e.category.id + "/" + i + "?" + t.param(n);
        },
        _updateModelAndHistory: function(t, e) {
            this._model.set(t, e), n.pushState(this._getStateFromModel(), document.title, this._serializeDataToUrl());
        },
        _clickContent: function(e) {
            var i = t(e.currentTarget);
            i.hasClass("selected") || this._updateModelAndHistory("content", i.data("content"));
        },
        _clickQueue: function(e) {
            var i = this._model.get("queues"), n = t(e.currentTarget), s = n.data("value").toString(), o = i.indexOf(s) >= 0, l = "all" !== s ? [ s ] : [];
            o || this._updateModelAndHistory("queues", l);
        },
        _renderContent: function() {
            this._$contentTypes.removeClass("selected"), this._$contentTypes.filter('[data-content="' + this._model.get("content") + '"]').addClass("selected");
        },
        _renderQueues: function() {
            var t = this._model.get("queues");
            this._$queues.removeClass("selected"), t.length ? t.forEach(function(t) {
                this._$queues.filter('[data-value="' + t + '"]').addClass("selected");
            }, this) : this._$queues.first().addClass("selected");
        }
    });
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
