...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(703) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, i) {
    "use strict";
    i.init(e(".js-curated-galleries"));
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(4), __webpack_require__(92), __webpack_require__(147) ], __WEBPACK_AMD_DEFINE_RESULT__ = function(e, t, o, i) {
    "use strict";
    return t.extend({
        init: function(e) {
            this._$context = e, this._projectCoverViews = [];
        },
        bind: function() {
            this._bindProjectsHover(), i.init(), this.relay(i, "postload");
        },
        unbind: function() {
            this._projectCoverViews.forEach(function(e) {
                e.destroy();
            }), this._projectCoverViews = [], i.destroy();
        },
        _bindProjectsHover: function() {
            var t = this;
            this._$context.find(".js-project-cover").each(function() {
                var i = new o(e(this));
                i.rendered(), t._projectCoverViews.push(i);
            });
        }
    });
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
